...
exports.InvestmentsModule = InvestmentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([portfolio_entity_1.UserPortfolio, user_entity_1.User]), assets_module_1.AssetsModule],
        controllers: [investments_controller_1.InvestmentsController],
        providers: [investments_service_1.InvestmentsService],
        exports: [typeorm_1.TypeOrmModule, investments_service_1.InvestmentsService]
    })
], InvestmentsModule);
