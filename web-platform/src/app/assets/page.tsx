            ...
            <div className="p-6 space-y-8 animate-in fade-in container mx-auto">
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-muted-foreground">إدارة الممتلكات والأصول الثابتة</p>
                    </div>
                </div>
                ...
                <div className="bg-card p-12 rounded-lg border border-border text-center space-y-6 shadow-sm min-h-[400px] flex flex-col items-center justify-center">
                    <Landmark className="w-16 h-16 text-muted-foreground/30" />
                    <div className="max-w-md space-y-2">
                        <h3 className="text-xl font-semibold text-foreground">سجل أصولك</h3>
                        <p className="text-muted-foreground">
                            أضف عقاراتك، سياراتك، أو أي أصول أخرى لتكتمل صورتك المالية وحساب زكاتك بدقة.
                        </p>
                    </div>
